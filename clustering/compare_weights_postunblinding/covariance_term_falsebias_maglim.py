...
wbias_dir = '/Users/jackelvinpoole/DES/lss_sys/scripts/y3_enet_contaminated_tests_maglim/'
wbias_files = {
	#'false_contam-enet_correct-fidpca108': wbias_dir+'false_bias_LNmock_enet_contam.txt',
	'false_contam-enet_correct-fidpca50': wbias_dir+'false_bias_LNmock_enet_contam_pca_50_maglim.txt',
}
...
angle = np.hstack([cen for i in range(6)])
