...
redmagic_dir = 	'/Users/jackelvinpoole/DES/cats/y3/redmagic/redmagic_0.5.1_wide/'
highdens_file   = redmagic_dir + 'y3_gold_2.2.1_wide_sofcol_run_redmapper_v0.5.1_redmagic_highdens.fit'
highlum_file    = redmagic_dir + 'y3_gold_2.2.1_wide_sofcol_run_redmapper_v0.5.1_redmagic_highlum.fit'
higherlum_file  = None
#higherlum_file  = redmagic_dir + 'y3_gold_2.2.1_wide_sofcol_run_redmagic_higherlum.fit'

outdir = 		'/Users/jackelvinpoole/DES/cats/y3/redmagic/combined_sample_0.5.1_wide_0.9binning_zmax0.9/'

label = 'y3_redmagic_v0.5.1_wide_gold_2.2.1_combined_hd3_hl2'
...
mask_file = '../masks/lens_sample_joint_mask/y3_gold_2.2.1_RING_joint_redmagic_v0.5.1_wide_maglim_v2.2_0.9maximum_mask.fits.gz'

randfiles = {
	'hidens':redmagic_dir +  'y3_gold_2.2.1_wide_sofcol_run_redmapper_v6.4.22_redmagic_highdens_0.5-10_randoms.fit',
	'hilum': redmagic_dir  + 'y3_gold_2.2.1_wide_sofcol_run_redmapper_v6.4.22_redmagic_highlum_1.0-04_randoms.fit',
	}
