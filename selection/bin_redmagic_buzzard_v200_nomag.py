...
redmagic_dir = 	'/global/cscratch1/sd/erykoff/redmagic_buzzard_temp/'
highdens_file   = redmagic_dir + 'buzzard_1.9.9_3y3a_rsshift_nomag_run_unmag_magcal_redmapper_v0.5.7_redmagic_highdens.fit'
highlum_file    = redmagic_dir + 'buzzard_1.9.9_3y3a_rsshift_nomag_run_unmag_magcal_redmapper_v0.5.7_redmagic_highlum.fit'
higherlum_file  = None
#higherlum_file  = redmagic_dir + 'y3_gold_2.2.1_wide_sofcol_run_redmagic_higherlum.fit'

outdir = 	'/global/project/projectdirs/des/jelvinpo/buzzard/y3_redmagic_buzzard_199_nomag_combined/'

label = 'y3_redmagic_buzzard_1.9.9_3y3a_nomag_run_unmag_magcal_combined_hd3_hl2'
...
#get mask from the buzzard h5 file
mask_dir = '/global/project/projectdirs/des/jderose/Chinchilla/Herd/Chinchilla-3/v2.0.0/sampleselection/Y3a/'
mask_file = mask_dir+'Buzzard-3_v2.0_Y3a_mastercat.h5'
input_order = 'NEST'
...
mask = lsssys.Mask(mask_file, input_order = input_order )
