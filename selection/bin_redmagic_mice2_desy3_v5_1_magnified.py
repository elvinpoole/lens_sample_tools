...
redmagic_dir = 	'/Users/jackelvinpoole/DES/cats/y3/MICE/redmagic/mice2_desy3_v5_1_magnified/'
highdens_file   = redmagic_dir + 'mice2_desy3_v5_1_magnified_run_redmagic_highdens.fit'
highlum_file    = redmagic_dir + 'mice2_desy3_v5_1_magnified_run_redmagic_highlum.fit'
higherlum_file  = None
#higherlum_file  = redmagic_dir + 'y3_gold_2.2.1_wide_sofcol_run_redmagic_higherlum.fit'

outdir = 		'/Users/jackelvinpoole/DES/cats/y3/MICE/redmagic/mice2_desy3_v5_1_magnified/combined_sample/'

label = 'mice2_desy3_v5_1_magnified_redmagic_combined_hd3_hl2'
...
mask_file = redmagic_dir + 'mice2_desy3_v5_1_magnified_run_vl50_vlim_zmask.fit'
mask_nside = 2048
usehealsparse=True
ZMAXcol='zmax'

randfiles = {
	'hidens':redmagic_dir +  'mice2_desy3_v5_1_magnified_run_redmagic_highdens_randoms.fit',
	'hilum': redmagic_dir  + 'mice2_desy3_v5_1_magnified_run_redmagic_highlum_randoms.fit',
	}
rand_ra_col='ra'
rand_dec_col='dec'
rand_z_col = 'z'
